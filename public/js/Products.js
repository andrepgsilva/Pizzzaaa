...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.$store.dispatch("getProducts").then(function (response) {
      _this.products = _this.$store.state.products;
    });
  }
});
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "rounded overflow-hidden shadow-lg mt-5 pb-16 ml-4 w-11/12 sm:w-1/4 md:w-1/4 lg:w-1/4"
    },
    [
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "flex justify-center h-full" }, [
    _c(
      "div",
      { staticClass: "container flex justify-start flex-wrap" },
