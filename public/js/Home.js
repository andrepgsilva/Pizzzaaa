...
// module
exports.push([module.i, ".banner[data-v-63cd6604] {\n  height: calc(100vh - 64px);\n}\n.banner-image[data-v-63cd6604] {\n  background-image: url(\"/img/pizzzaaa-banner.jpg\");\n  background-repeat: no-repeat;\n  background-position: center;\n  background-size: cover;\n  height: 100%;\n}\n", ""]);
...
var render = function() {
  ...
  return _c("div", { staticClass: "banner w-100" }, [
    _c(
      "div",
      {
        staticClass:
          "flex items-center sm:items-baseline md:items-baseline lg:items-baseline banner-image"
      },
      [
        _c("div", { staticClass: "justify-start w-full" }, [
          _c(
            "div",
            {
              staticClass:
                "flex flex-col sm:w-1/3 md:w-1/3 lg:w-1/3 sm:mt-44 md:mt-44 lg:mt-44 mx-10 p-6 rounded bg-yellow-300"
            },
            [
              _vm._m(0),
              _vm._v(" "),
              _c(
                "h2",
                { staticClass: "banner-subtitle my-2 text-3xl text-gray-900" },
                [_vm._v("Buy Our Delicious Pizzas")]
              ),
              _vm._v(" "),
              _c(
                "router-link",
                {
                  staticClass:
                    "focus:outline-none outline-none mt-4 text-center text-2xl p-4 text-gray-100 bg-red-600 hover:bg-red-700 rounded",
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "h1",
      { staticClass: "banner-title leading-snug text-6xl text-gray-900" },
      [_vm._v("Are You "), _c("br"), _vm._v(" Hungry?")]
    )
  }
]
...
/***/ 3:
/*!*******************************************!*\
  !*** multi ./resources/js/views/Home.vue ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/andrepgsilva/code/Pizzzaaa/resources/js/views/Home.vue */"./resources/js/views/Home.vue");
